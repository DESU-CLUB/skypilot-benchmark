...
def test_finetune_job_yaml_does_not_exist():
    assert not os.path.isfile("/home/user/finetune_job.yaml"), \
        "finetune_job.yaml should not exist at the start of the task."
