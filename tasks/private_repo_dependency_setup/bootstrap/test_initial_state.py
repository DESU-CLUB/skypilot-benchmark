...
def test_private_train_yaml_does_not_exist():
    assert not os.path.isfile("/home/user/private_train.yaml"), \
        "private_train.yaml should not exist at the start of the task."
