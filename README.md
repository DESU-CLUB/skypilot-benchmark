...
This repository contains benchmarks for [SkyPilot](https://skypilot.readthedocs.io/), a framework for running AI and ML workloads on any cloud.

You can view the evaluation reports at [skypilot-benchmark](https://desu-club.github.io/skypilot-benchmark/).
